...
export const en: Translations = {
  ...
  project: "Project",
  local: "Local",
  projectConfigToml: "Project config TOML",
  ...
  heroPoint2: "Project-defined commands require one-time approval.",
  heroPoint3: "Project-level settings and logs in the Settings page.",
