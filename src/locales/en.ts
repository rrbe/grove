...
export const en: Translations = {
  ...
  defaultWorktreeRootLabel: "Default Worktree Directory",
  defaultWorktreeRootHint: "Relative path shared across all repos. Per-repo settings override this. Leave blank to use built-in default .claude.",
  worktreeRootPlaceholderFallback: "Inherits global: ",
